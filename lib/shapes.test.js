...
describe('Circle', () => {
    describe('render', () => {
        it('should return to equal if shape color is set to green and text is white', () => {
            ...
            const expected = '<circle cx="150" cy="100" r="100"  stroke="green"  fill="green" stroke-width="2"/><text x="135" y="100" fill="white">Text</text>'
...
describe('Triangle', () => {
    describe('render', () => {
        it('should return to equal if shape color is set to green and text is white', () => {
            ...
            const expected = '<polygon  points="103,0 200,150 15,150" fill="green"  stroke="green"  stroke-width="1"/><text x="85" y="100" fill="white">Text</text>'
            const callShape = shape.render('green', 'white')
            expect(callShape).toEqual(expected)
        })
    })
...
describe('Square', () => {
    describe('render', () => {
        it('should return to equal if shape color is set to green and text is white', () => {
            ...
            const expected = '<rect x="50" y="0" width="200" height="200" stroke="green" fill="green" stroke-width="2"/><text x="135" y="100" fill="white">Text</text>'
            const callShape = shape.render('green', 'white')
            expect(callShape).toEqual(expected)
        })
    })
